...
const Cust = () => {
    ...
    return (
        <div className="landing-page">
            ...
            <div className="alloy-complete-customization-section container-fluid py-5" id='cuc' style={{ backgroundColor: '#fff5ee', color: '#000000' }}>
            <h2 className="text-center mb-5" style={{ fontSize: '46px', fontWeight: 'bold' }}>Alloy Wheel Customization</h2>
  ...
  <p style={{ fontSize: '20px', fontWeight: 'bold' }}>
    Click the image to view the transformation from a worn-out wheel to a fully customized, high-end finish. 
    Our customization services offer limitless options to create a style that’s uniquely yours while ensuring durability and performance.
  </p>
  <ul style={{ fontSize: '20px', fontWeight: 'bold' }}>
    <li>Repair and eliminate all visible damage, including chips, scratches, and curb rash</li>
    <li>Apply a durable finish that resists wear, scratches, and corrosion</li>
    <li>Customize factory color or apply a unique finish to match your personal style</li>
    <li>Choose from a variety of finishes, including matte, satin, gloss, or metallic</li>
    <li>Color-match wheels to your vehicle’s trim for a seamless, coordinated look</li>
    <li>Add accents such as two-tone or multi-color designs for an eye-catching effect</li>
    <li>Diamond cutting and polishing services for a sleek, high-definition finish</li>
    <li>High-temperature clear coatings to protect your wheels from the elements</li>
  </ul>
  <p style={{ fontSize: '20px', fontWeight: 'bold' }}>
    Whether you’re looking to restore a factory-fresh appearance or create a bold, custom look, 
    our alloy wheel customization services are tailored to meet your needs. 
    We prioritize craftsmanship and quality to ensure your wheels stand out and last for years to come.
  </p>
</div>
            ...
            <div className="row justify-content-center px-3 px-md-5">
                <div className="col-lg-2 col-md-4 col-6 mb-4 d-flex justify-content-center">
                    <img src={au} alt="Audi" className="alloy-wheel-img img-fluid" />
                </div>
                <div className="col-lg-2 col-md-4 col-6 mb-4 d-flex justify-content-center">
                    <img src={ja} alt="Jaguar" className="alloy-wheel-img img-fluid" />
                </div>
                <div className="col-lg-2 col-md-4 col-6 mb-4 d-flex justify-content-center">
                    <img src={mb} alt="Mercedes Benz" className="alloy-wheel-img img-fluid" />
                </div>
                <div className="col-lg-2 col-md-4 col-6 mb-4 d-flex justify-content-center">
                    <img src={bm} alt="BMW" className="alloy-wheel-img img-fluid" />
                </div>
                <div className="col-lg-2 col-md-4 col-6 mb-4 d-flex justify-content-center">
                    <img src={be} alt="Bentley" className="alloy-wheel-img img-fluid" />
                </div>
            </div>

            {/* Process Overview */}
            <div className="alloy-process-overview my-5 text-center p-5">
                <h3 style={{ fontSize: '46px', fontWeight: 'bold' }}>Our Customization Process</h3>
                <p style={{ fontSize: '20px', fontWeight: 'bold' }} className="text-muted">
                    Our detailed customization process ensures your wheels are enhanced for both aesthetics and performance. 
                    Every step is handled with precision to deliver high-quality, lasting results.
                </p>

                <div className="alloy-process-steps row mt-5">
                    {/* Step 1 - Inspection */}
                    <div className="col-md-4 mb-4">
                        <div className="process-step text-center">
                            ...
                            <p>Thorough inspection to identify damage, bends, or cracks. We assess structural integrity before customization.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="process-step text-center">
                            ...
                            <p>Deep cleaning to remove dirt, debris, and old finishes, ensuring a smooth base for customization.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="process-step text-center">
                            ...
                            <p>Precision straightening corrects any bends or warps for a smooth ride and better performance.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="process-step text-center">
                            ...
                            <p>Custom colors and finishes are applied with precision, along with protective coatings for durability.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="process-step text-center">
                            ...
                            <h4 className="process-title">Step 5: Quality Check</h4>
                            <p>Final inspection ensures all customization meets our high-quality standards before delivery.</p>
                        </div>
                    </div>
                </div>
                </div>
