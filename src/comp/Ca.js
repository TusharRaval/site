...
const Ca = () => {
    ...
    return (
        <div className="landing-page">
            ...
            <div className="cali-complete-refurbishment-section container-fluid py-5" id='ccc' style={{backgroundColor:'#fff5ee',color:'#000000'}}>
    <h2 className="text-center mb-5" style={{ fontSize: '46px', fontWeight: 'bold' }}>Calliper painting</h2>
  ...
  <p style={{ fontSize: '20px', fontWeight: 'bold' }}>
    Click the image to view the transformation from a worn-out wheel to a like-new finish. We restore all kinds of damage, including corrosion, curb rash, and discoloration.
  </p>
  <ul style={{ fontSize: '20px', fontWeight: 'bold' }}>
    <li>Repair and eliminate all visible damage</li>
    <li>Apply a durable finish that resists wear</li>
    <li>Restore factory color or apply a custom finish</li>
  </ul>
  
  <h3 className="mt-4" style={{ fontSize: '36px', fontWeight: 'bold' }}>Caliper Painting Services</h3>
  <p style={{ fontSize: '20px', fontWeight: 'bold' }}>
    Enhance the look of your alloy wheels with our professional caliper painting services. Custom caliper colors can add a sleek, sporty touch to your vehicle, while also protecting your calipers from rust and wear.
  </p>
  <ul style={{ fontSize: '20px', fontWeight: 'bold' }}>
    <li>Wide selection of colors and finishes, including gloss, matte, and metallic</li>
    <li>High-temperature paint to withstand extreme heat and ensure long-lasting results</li>
    <li>Corrosion resistance for enhanced durability and protection</li>
    <li>Custom designs and decals available for a truly unique look</li>
    <li>Seamless integration with your alloy wheels for a cohesive, polished appearance</li>
  </ul>
  <p style={{ fontSize: '20px', fontWeight: 'bold' }}>
    Our caliper painting service is perfect for car enthusiasts looking to make their wheels stand out while ensuring maximum protection. Let us elevate your vehicle’s style with our precision caliper painting and alloy wheel refinishing services.
  </p>
</div>
